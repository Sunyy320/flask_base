...
def currency(val, symbol=True, grouping=False, international=False):
    """Formats val according to the currency config
...
def atof(string, func=float):
    "Parses a string as a float according to the locale config."
...
def atoi(str):
    "Converts a string to an integer according to the locale config."
    return atof(str, int)
...
def getdefaultlocale(envvars=('LC_ALL', 'LC_CTYPE', 'LANG', 'LANGUAGE')):
    ...
    """ Tries to determine the default locale config and returns
...
def _print_locale():
    ...
    print 'Locale config on startup:'
    print '-'*72
    ...
    print
    print 'Locale config after calling resetlocale():'
    print '-'*72
    resetlocale()
    for name,category in categories.items():
        print name, '...'
    ...
    try:
        ...
        print
        print 'Locale config after calling setlocale(LC_ALL, ""):'
        print '-'*72
        for name,category in categories.items():
            print name, '...'
            lang, enc = getlocale(category)
